...
import { Carousel, Comment, Avatar, Form, Button, List, Input,Rate } from 'antd';
...
export class Reviews extends Component {
	state = {
        ...
        commentRate:0,
		reviews: [
			{ content: 'the best seller in the world', value: 3, name: 'Eliran Suissa' },
		...
		return (
			<div>
                ...
                <div className="comment-area-container">
                    ...
                    />
                    <Rate defaultValue={3} value={commentRate} onChange={this.commentRateChanged}/>
