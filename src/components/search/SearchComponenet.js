...
class SearchComponenet extends Component {
	...
	renderAllProducts = () => {
		...
		if (products.length > 0) {
			...
			return (
				<div style={{ textAlign: 'center', paddingBottom: 30, paddingLeft: 25 }}>
					<h2>Not any Produts Found</h2>
				</div>
			);
		}
	};
		...
		return (
			<div className="search-page-main-container">
				<div className="search-tab" style={{ padding: '35px 0px' }}>
					<SearchMain history={this.props.history} onSearchClicked={this.onSearchClicked} />
				</div>
