      ...
      <React.Fragment>
        ...
        >
          <Card
            ...
            title={titleRenderer("Why Semi ?", 30)}
            bordered={false}
          >
            <Col span={6}>
              ...
              <div>
                {contentRenderer(
                  "We do the rest for you online, including lease agreement and payments",
                  "",
                  12
                )}
              </div>
            ...
            <Col span={6}>
              ...
              <div>
                {contentRenderer(
                  "We check our members' identity and protect your liability.",
                  "",
                  12
                )}
              </div>
            ...
            <Col span={6}>
              ...
              <div>
                {contentRenderer(
                  "We deliver to your location within Twin Cities Metro in three hours or less.",
                  "",
                  12
                )}
              </div>
