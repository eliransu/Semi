		...
		return (
			<Layout className="layout">
				...
				<Menu theme="light" mode="horizontal" defaultSelectedKeys={[ '1' ]} style={{ lineHeight: '85px' }}>
					...
					<Menu.Item style={{ fontSize: 16 }} key="6" onClick={() => this.handleMenuClicked('about')}>
						<Icon fontSize={16} style={{ marginLeft: 4 }} type="team" />
						About Us
					</Menu.Item>

					<Menu.Item style={{ fontSize: 16 }} key="7" onClick={() => this.handleMenuClicked('signin')}>
						<Icon fontSize={16} style={{ marginLeft: 4 }} type="form" />
						Sign in
					</Menu.Item>

					<Menu.Item style={{ fontSize: 16 }} key="8" onClick={authStore.toggleviewLoginModal}>
