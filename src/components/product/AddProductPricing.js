...
{getFieldDecorator('pricing', {
  rules: [{ required: true,message:'Pleace enter Price and Period' }],
})(
  <span style={{ display: "flex" }}>
    <DynamicFieldSet addedClicked={this.addedClicked} onPeriodPricingChanged={this.onPeriodPricingChanged} onPeriodSelected={this.onPeriodSelected}/>
  </span>
)}
